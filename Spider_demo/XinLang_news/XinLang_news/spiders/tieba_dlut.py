...
class TiebaDlutSpider(scrapy.Spider):
    name = "tieba_dlut"
    allowed_domains = ["baidu.com"]
    start_urls = (
        'http://tieba.baidu.com/f?ie=utf-8&kw=%E5%A4%A7%E8%BF%9E%E7%90%86%E5%B7%A5%E5%A4%A7%E5%AD%A6&fr=search',
    )
...
#             print author_id
        ...
        if self.Flag_List[index] and self.Maxpage_List[index]>0:
            nextpage_url = 'http://tieba.baidu.com' + all_content.find_all("a", class_=u"next")[0].get('href')
            print nextpage_url
            raw_input('--')
