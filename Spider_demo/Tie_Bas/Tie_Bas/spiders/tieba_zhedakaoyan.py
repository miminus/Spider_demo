...
class TiebaZhedakaoyanSpider(scrapy.Spider):
    name = "tieba_zhedakaoyan"
    allowed_domains = ["baidu.com"]
    start_urls = (
        'http://tieba.baidu.com/f?ie=utf-8&kw=%E6%B5%99%E5%A4%A7%E8%80%83%E7%A0%94',
    )
...
#             print topic.extract()
#             print temp_sel.xpath('//span[re:test(@class,"threadlist_reply_date pull_right j_reply_data")]')
#             raw_input('--')
