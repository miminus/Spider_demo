...
class Gaokao1977Spider(scrapy.Spider):
    name = "gaokao_1977"
#     allowed_domains = ["baidu.com"]
    start_urls = [
            'http://tieba.baidu.com/f?kw=%E9%AB%98%E8%80%831977&ie=utf-8&pn=0',
            'http://tieba.baidu.com/f?kw=%E9%AB%98%E8%80%831977&ie=utf-8&pn=50',
            'http://tieba.baidu.com/f?kw=%E9%AB%98%E8%80%831977&ie=utf-8&pn=100',
    ...
    def __init__(self,mailer=None):
        super(Gaokao1977Spider,self).__init__()
...
#             print author_id
    ...
    def parse_torrent(self,response):
        ...
        topic_item['topic_board']='高考1977贴吧'
