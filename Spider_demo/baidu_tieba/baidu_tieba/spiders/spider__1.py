...
import scrapy
import time
# from ..items import Topic_Item
# from .. import items
class DmozSpider_gaokao(CrawlSpider):
    name = "gaokao"
    allowed_domains = ["tieba.baidu.com"]
    
    start_urls = [
            'http://tieba.baidu.com/f?kw=%E9%AB%98%E8%80%83&ie=utf-8&pn=0',
            'http://tieba.baidu.com/f?kw=%E9%AB%98%E8%80%83&ie=utf-8&pn=50',
            'http://tieba.baidu.com/f?kw=%E9%AB%98%E8%80%83&ie=utf-8&pn=100',

    ]
    def start_requests(self):
        db = mdb.connect(host="127.0.0.1",user="root",passwd="minus",db="yq",charset="utf8" )
        cur=db.cursor()
        cur.execute('select topic_id,topic_keywords from topic where topic_id in (select topic_id from site_topic where site_id=12)')
    ...
    def __init__(self,mailer=None):
        super(DmozSpider_gaokao,self).__init__()
...
#             print post_time
    ...
    def parse_torrent(self,response):
        ...
        topic_item['topic_board']='高考贴吧'
        topic_item['site_id']=12
