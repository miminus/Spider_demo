...
class DaanSpider(scrapy.Spider):
    name = "daan"
    start_urls = [
...
#             'http://tieba.baidu.com/f?kw=%E5%AD%A6%E7%94%9F&ie=utf-8&pn=100',
    ...
    def start_requests(self):
        ...
        cur=db.cursor()
        cur.execute('select topic_id,topic_keywords from topic where topic_id in (select topic_id from site_topic where site_id=30)')
    ...
    def __init__(self,mailer=None):
        super(DaanSpider,self).__init__()
...
#             print author_id
    ...
    def parse_torrent(self,response):
        ...
        topic_item['topic_board']='答案贴吧'
        topic_item['site_id']=30
