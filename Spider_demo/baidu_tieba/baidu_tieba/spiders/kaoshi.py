...
class DmozSpider_kaoshi(CrawlSpider):
    name = "kaoshi"
    allowed_domains = ["tieba.baidu.com"]
    
    start_urls = [
            'http://tieba.baidu.com/f?kw=%BF%BC%CA%D4&ie=utf-8&pn=0',
#             'http://tieba.baidu.com/f?kw=%BF%BC%CA%D4&ie=utf-8&pn=50',
#             'http://tieba.baidu.com/f?kw=%BF%BC%CA%D4&ie=utf-8&pn=100',

    ]
    def start_requests(self):
        db = mdb.connect(host="127.0.0.1",user="root",passwd="minus",db="yq",charset="utf8" )
        cur=db.cursor()
        cur.execute('select topic_id,topic_keywords from topic where topic_id in (select topic_id from site_topic where site_id=11)')
    ...
    def __init__(self,mailer=None):
        super(DmozSpider_kaoshi,self).__init__()
...
#             print author_id
    ...
    def parse_torrent(self,response):
        ...
        topic_item['topic_board']='考试贴吧'
        topic_item['site_id']=11
