...
class GenyunSpider(scrapy.Spider):
    name = "genyun"
    allowed_domains = ["ndsytw.cn"]
    start_urls = [
        'http://www.ndsytw.cn/search.php?mod=forum&searchid=1&orderby=lastpost&ascdesc=desc&searchsubmit=yes&kw=%B8%DF%BF%BC',
        'http://www.ndsytw.cn/search.php?mod=forum&searchid=2&orderby=lastpost&ascdesc=desc&searchsubmit=yes&kw=%B4%F0%B0%B8',
    ]
    ...
    def __init__(self,mailer=None,*args, **kwargs):
        super(GenyunSpider,self).__init__()
    ...
    def parse(self, response):
        ...
        for topic in topic_lists:
            ...
            url = 'http://www.ndsytw.cn/' + topic.find_all("a")[0].get('href')
            print url
            ...
            topic_item['homepage'] = 'http://www.ndsytw.cn/'+homepage
